...
export default function Command() {
  ...
  return (
    <List
      ...
      // throttle
    >
      <List.Section title="Results" subtitle={(searchResults?.length && searchResults?.length == 20) ? searchResults?.length + "+" : searchResults?.length + ""}>
          ...
          actions={
            <ActionPanel>
              <ActionPanel.Section>
                ...
                {searchResult.homepage_url ? <Action.OpenInBrowser title="Open Website" url={searchResult.homepage_url} /> : null }
                {searchResult.facebook_url ? <Action.OpenInBrowser title="Open Facebook" url={searchResult.facebook_url} /> : null }
                {searchResult.twitter_url ? <Action.OpenInBrowser title="Open Twitter" url={searchResult.twitter_url} /> : null }
                {searchResult.linkedin_url ? <Action.OpenInBrowser title="Open Linkedin" url={searchResult.linkedin_url} /> : null }
              </ActionPanel.Section>
              <ActionPanel.Section>
            ...
            <List.Item.Detail 
              ...
              metadata={
                <List.Item.Detail.Metadata>
                  ...
                  {searchResult.facebook_url ? <List.Item.Detail.Metadata.Link title="Facebook" target={searchResult.facebook_url} text="Link" /> : null}
                  {searchResult.twitter_url ? <List.Item.Detail.Metadata.Link title="Twitter" target={searchResult.twitter_url} text="Link" /> : null}
                  {searchResult.linkedin_url ? <List.Item.Detail.Metadata.Link title="Linkedin" target={searchResult.linkedin_url} text="Link" /> : null}
                  {searchResult.homepage_url ? <List.Item.Detail.Metadata.Link title="Website" target={searchResult.homepage_url} text={searchResult.domain} /> : null}
                </List.Item.Detail.Metadata>
              }
            />
          }
